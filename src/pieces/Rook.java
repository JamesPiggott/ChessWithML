...
public class Rook implements Pieces {
	...
	private boolean isPossibleMove(int firstPosition, int thirdPosition) {
		...
		if (firstPosition + 8 == thirdPosition || firstPosition - 8 == thirdPosition || firstPosition + 16  == thirdPosition || firstPosition - 16 == thirdPosition || firstPosition + 24 == thirdPosition || firstPosition - 24 == thirdPosition || firstPosition + 32 == thirdPosition || firstPosition - 32 == thirdPosition || firstPosition + 40 == thirdPosition || firstPosition - 40 == thirdPosition || firstPosition + 48 == thirdPosition || firstPosition - 48 == thirdPosition || firstPosition + 56 == thirdPosition || firstPosition - 56 == thirdPosition) {
			return true;
